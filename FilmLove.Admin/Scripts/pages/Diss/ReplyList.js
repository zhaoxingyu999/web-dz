...
var itemJS = {
    ...
    delete: function (id) {
        ...
        if (r == true) {
            ajaxHelper.post('/Diss/DeleteReply', pd, function (d) {
    ...
    outList: function (r, j) {
        ...
        for (var i = 0; i < r.length; i++) {
            ...
            html += '<tr>\
                ...
                <td class="text-center">' + tools.nullToEmptyString(d.DissId) + '</td>\
                <td class="text-center">' + formatHelper.formatTime(d.ReplyTime) + '</td>\
