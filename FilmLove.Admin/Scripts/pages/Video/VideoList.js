...
var itemJS = {
    ...
    delete: function (id) {
        ...
        if (r == true) {
            ajaxHelper.post('/Video/DeleteVideo', pd, function (d) {
    ...
    outList: function (r, j) {
        ...
        for (var i = 0; i < r.length; i++) {
            ...
            html += '<tr>\
                ...
                <td class="text-center">' + tools.nullToEmptyString(d.BaseUserId) + '</td>\
                <td class="text-center">' + tools.nullToEmptyString(d.BaseUserName) + '</td>\
                <td class="text-center">' + formatHelper.formatTime(d.UploadTime) + '</td>\
                ...
                <td class="text-center"><a href="javascript:void(0);" onclick="itemJS.delete(' + d.VideoId+')">删除</a></td>\
                </tr > ';
            //<td class="text-center"><video src="' + tools.nullToEmptyString(d.Url) + '" /></video></td >\
        }
        $("#infodata").html(html);
    },
};