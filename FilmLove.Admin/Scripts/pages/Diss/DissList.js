...
var itemJS = {
    ...
    delete: function (id) {
        ...
        if (r == true) {
            ajaxHelper.post('/Diss/DeleteDiss', pd, function (d) {
    ...
    outList: function (r, j) {
        ...
        for (var i = 0; i < r.length; i++) {
            ...
            html += '<tr>\
                ...
                <td class="text-center">' + tools.nullToEmptyString(d.UserId) + '</td>\
                ...
                <td class="text-center">' + formatHelper.formatTime(d.DissTime) + '</td>\
