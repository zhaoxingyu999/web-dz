...
namespace FilmLove.Business.Utility
{
    ...
    public class FileUploadHelper
    {
        public static AjaxResult UploadFileOne(string FileTypeName)
        {
            ...
            try
            {
                ...
                string dirPath = string.Format("/FilmLove/Upload/{0}/{1:yyyyMM}/", FileTypeName, DateTime.Now);
                ...
                //{
                //    URLPath="http://ahalfi.dualpsy.com/singlego"+ABSPath;
                //}
#endif
